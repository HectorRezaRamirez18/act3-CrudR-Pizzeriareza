                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="tipo_paquete" id="tipo_paquete" placeholder="Tipo de paquete" >
                            </div>
                            <div class="mb-3">
                                <label for="acompanamiento" class="form-label">Acompañamiento</label>
                                <input type="text" class="form-control" name="acompanamiento" id="acompanamiento" placeholder="Acompañamiento">
                            </div>
