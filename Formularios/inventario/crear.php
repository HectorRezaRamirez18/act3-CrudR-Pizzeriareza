                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="id_Ingrediente" name="id_Ingrediente" placeholder="id Ingrediente">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="Precio_Ingrediente" id="Precio_Ingrediente" placeholder="Precio ingrediente" >
                            </div>
                            <div class="mb-3">
                                <label for="id_Proveedor" class="form-label">id Proveedor</label>
                                <input type="text" class="form-control" name="id_Proveedor" id="id_Proveedor" placeholder="id Proveedor">
                            </div>
                            <div class="mb-3">
                                <label for="Fecha_Entrega" class="form-label">Fecha de entrega</label>
                                <input type="date" class="form-control" name="Fecha_Entrega" id="Fecha_Entrega" placeholder="Fecha de entrega" >
                            </div>
                            <div class="mb-3">
                                <label for="Cantidad_Ingredientes" class="form-label">Cantidad de ingredientes</label>
                                <input type="text" class="form-control" name="Cantidad_Ingredientes" id="Cantidad_Ingredientes" placeholder="Cantidad de ingredientes">
                            </div>
